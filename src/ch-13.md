...
在*./frontend/*新建主题文件夹*themes/*。

```bash
$ mkdir ./frontend/themes
```

复制主题样式到*./frontend/themes/*文件夹下，

```bash
$ cp -r ./vendor/dmstr/yii2-adminlte-asset/example-views/yiisoft/yii2-app ./frontend/themes/adminlte
```

编辑配置文件*./frontend/config/main.php*，
...
编辑文件*./frontend/themes/adminlte/layouts/main.php*，修改替换相应代码。
