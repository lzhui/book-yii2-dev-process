...
composer create-project yiisoft/yii2-app-advanced wuzhishan 2.0.9
```
...
在xampp中使用phpmyadmin创建数据库`db_wuzhishan`，当前该数据库为空。
下面导入该数据库。
...
xampp 数据库操作部分见本书第一部分相关章节。<span style="color: rgb(255, 0, 0);">这里有错误。</span>
